...
//    private TextView title;
    ...
    private org.fundsofhope.android.model.ProjectDescription projectDescription;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (NetworkUtilities.isInternet(ProjectDescriptionActivity.this)) {
            ApiInterface apiInterface = ServiceGenerator.createService(ApiInterface.class);
            apiInterface.project_detail(project.getId(),
                    new retrofit.Callback<org.fundsofhope.android.model.ProjectDescription>() {

                        @Override
                        public void success(final org.fundsofhope.android.model.ProjectDescription project_description, Response response) {
...
//        if (NetworkUtilities.isInternet(ProjectDescriptionActivity.this)) {
//            ApiInterface apiInterface = ServiceGenerator.createService(ApiInterface.class);
//            apiInterface.donate(2,project.getId(),1,
//                    new retrofit.Callback<SignupStatus>() {
//
//                        @Override
//                        public void success(final org.fundsofhope.android.model.SignupStatus _status, Response response) {
//                             specify an adapter (see also next example)
//                           SignupStatus status = _status;
//                            title.setText(project_description.getTitle());
//                            Toast.makeText(ProjectDescriptionActivity.this,status.getStatus(),Toast.LENGTH_LONG).show();
//
//
//                        }
//
...
//        }
    ...
    private class LongOperation2 extends AsyncTask<String, Void, SignupStatus> {
        ...
        protected void onPreExecute() {
            ...
            // + "\"}";
//            data = "user_id=2"+"project_id="+project.getId()+"amount=0";
            // data +=
...
//            if(response==null)
//                Toast.makeText(ProjectDescriptionActivity.this, "Donation Successful",Toast.LENGTH_LONG).show();
            if(response.getStatus().equals("Donation Successful") || response.getStatus().equals("User updated"))
            {
                Intent intent = new Intent(ProjectDescriptionActivity.this, SuccessDonation.class);
                Gson gson = new Gson();
