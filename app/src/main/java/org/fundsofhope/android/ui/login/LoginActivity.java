package org.fundsofhope.android.ui.login;
...
import org.fundsofhope.android.ui.main.MainActivity;
import org.fundsofhope.android.ui.splash.SplashActivity;
    ...
    private class LongOperation2 extends AsyncTask<String, Void, SignupStatus> {
        ...
        protected SignupStatus doInBackground(String... urls) {
            ...
            try {
                ...
                httpcon = (HttpURLConnection) ((new URL("http://api.fundsofhope.org/user/signup/").openConnection()));
